...
+ 開始使用{#getting-started}
   ...
   + [從 Campaign Standard移轉後，開始使用 Adobe Campaign v8](https://experienceleague.adobe.com/docs/campaign-learn/get-started-with-campaign-v8/overview.html?lang=zh-Hant)
