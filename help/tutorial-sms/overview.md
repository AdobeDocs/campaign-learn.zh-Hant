...
* **[為標準 SMPP 提供者設定簡訊帳戶](/help/tutorial-sms/set-up-account-for-standard-smpp-provider.md)**
  *了解如何將簡訊連接器調整至您的 SMPP 提供者。微調簡訊設定以處理連線限制。  瞭解如何設定最大輸送量、傳送視窗和TLS加密。*

* **[將簡訊聯結器調整至您的SMPP提供者](/help/tutorial-sms/adapt-sms-connector-to-smpp-provider.md)**
  *瞭解如何微調簡訊設定以處理連線限制。 瞭解如何設定最大輸送量、傳送視窗和TLS加密。*
