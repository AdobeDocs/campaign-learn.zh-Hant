---
title: 與 Experience Platform 整合 — 概觀
...
# 與 Experience Platform 整合 — 概觀

了解如何在 Campaign 和 Experience Cloud 之間共用資料。

>[!VIDEO](https://video.tv.adobe.com/v/3441275?captions=chi_hant&quality=12&learn=on){transcript=true}

## 額外資源

### 文件

* [開始使用來源和目標](https://experienceleague.adobe.com/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/aep-sources-destinations/get-started-sources-destinations.html?lang=zh-Hant#)
